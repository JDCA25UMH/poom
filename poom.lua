...
shot01= Disparo.new(sw/2, sh/2)
shot02 = Disparo.new(sw/2,sh/2)
shot03 = Disparo.new(sw/2, sh/2)
shot04 = Disparo.new(sw/2, sh/2)

muestra = Disparo.new(sw/2, sh/2)
 balas01= {}
 balas02 = {}
 balas03={}
 balas04 = {}
...
table.insert(balas01, nuevaBala)
 nuevaBala02={}
...
table.insert(balas02, nuevaBala02)
...
table.insert(balas03, nuevaBala03)
...
table.insert(balas04,nuevaBala04)
...
for i=bl,1,-1 do 
 ...
 balas01[i].x = balas01[i].x +
 velocidad
 balas01[i].y = balas01[i].y-
 velocidad

 if balas01[i].x<0 and
 balas01[i].y<0 then
 table.remove(balas01,i)
end
end
end

local bl2 = #balas02
local bl2 = math.min(bl2,150)
for i=bl2,1,-1 do 
for i=bl2,1,-1 do
 balas02[i].x = balas02[i].x -0.5
 balas02[i].y = balas02[i].y+0.5
end
if balas02[i].x<0 and
balas02[i].y<0 then
 table.remove(balas02,i)
end
end

local bl3 = #balas03
local bl3= math.min(bl3,150)
for i=bl3,1,-1 do
for i=bl3,1,-1 do 
 
 balas03[i].x = balas03[i].x -0.5
 balas03[i].y = balas03[i].y -0.5

 end
if  balas03[i].x>sw then
 table.remove(balas03,i)
end
end

local bl4 = #balas04
local bl4 = math.min(bl4,150)
 for i=bl4 ,1,-1 do
 for i=bl4,1,-1 do
  balas04[i].x = balas04[i].x +0.5
  balas04[i].y= balas04[i].y +0.5

 end
if balas04[i].x<0 then
 table.remove(balas04,i)
end
end
...
---------------------------------------------------------------
function buton_restart(func,
buton_color, text_color, width,height)
  mx , my = getMPos()
 return {
  func = func or function() 
  print("no func",1,1) end,
  text_color=text_color or 
  {r=0,g=0,b=0},
  buton_color = buton_color or 
  {r=1,g=1,b=1},
  width= width or 100,
 ...
 draw = function (self, text, buton_x,
  ...
  self.buton_x = buton_x or
  self.buton_x
  self.buton_y = buton_y or
  self.buton_y
...
---------------------------------------------------------------
 ...
 buton_restart(apuntar ,
 {r=buttons.colors["red"],
 g=buttons.colors["green"],
 b= buttons.colors["blue"]},
 {r=0,g=0,b=0},40,10 ) 

------------------------------------------------------------
function buton_clean(func,buton_color,
...
buton_y, text_x, text_y) 
 self.text = text
  or self.text
 self.buton_x = buton_x
  or self.buton_x
 self.buton_y = buton_y
  or self.buton_y
...
---------------------------------------------------------------
buttons.clean.clean_01= buton_clean(
vacio,{r=buttons.colors["red"],
g= buttons.colors["green"],
b= buttons.colors["blue"]},
{r=0,g=0,b=0},40,10)
...
function _draw()
 ...
 local function dibujarBalas(balas)
...
if bl<149 then
 dibujarBalas(balas01)
end
if bl_2<149 then 
 dibujarBalas(balas02)
end
  
if bl_3<149 then 
  dibujarBalas(balas03)
 end
  
if bl_4<149 then
 dibujarBalas(balas04)
end
 ...
 local bl= math.min(bl,150)
 if bl==150 then
 Sprite(2,muestra.x, muestra.y)
 
 end
 
color(5)
buttons.restart.restart_01:draw("Restart",
sw/12,sh-12,10,10)
color(7)
print("Restart",sw/12+2,sh-10)

color(5)
buttons.clean.clean_01:draw(
"Clean",sw/2,sh-12,10,10)
color(7)
print("Clean",sw/2+7,sh-10)
...

